...
public class ContaCorrente {
     ...
     */
    public void transferir(float valor, ContaCorrente contaDestino) throws SaldoInsuficienteException, SaqueDeValorNaoPositivoException {
        // valida o parâmetro
        if (valor <= 0) {
            throw new SaqueDeValorNaoPositivoException();
        }
        ...
        if (valor > saldoEmReais + LIMITE_CHEQUE_ESPECIAL) {
            throw new SaldoInsuficienteException(valor - saldoEmReais + LIMITE_CHEQUE_ESPECIAL);
        }
