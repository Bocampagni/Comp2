...
public class ContaCorrenteTest {
    ...
    public void testarDeposito() throws  DepositoDeValorNaoPositivoException {
        ...
        }catch (DepositoDeValorNaoPositivoException exception){
    ...
    @Test
    public void testarTransferecia() throws SaldoInsuficienteException, SaqueDeValorNaoPositivoException {
    ...
    @Test()
    public void testarTransfereciaSemFundosNaContaDeOrigem() throws SaldoInsuficienteException, SaqueDeValorNaoPositivoException {
        // sanity check: as contas já começam com saldo 10 (regra de negócio)
        assertFloatEquals(10f, contaDaMaria.getSaldoEmReais());
