...
//        impressora.imprimir("blah");
        ...
        Livro livro1 = new Livro(11111, "O Pequeno Principe", "Saint Exupery",
                "Abril", 1920);
        livro1.setPrecoEmReais(12);

        minhaLoja.incluirItemComQuantidade(livro1,30);

        Usuario joao = new Usuario(123456, "Joao");
        joao.setEndereco("asd");
        ...
        while (true) {
            try {
                System.out.println(minhaLoja.receberPedido(livro1, quantidadeDesejada, joao));
