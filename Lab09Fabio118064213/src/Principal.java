...
//        impressora.imprimir("blah");
        ...
        Livro livro1 = new Livro(11111, "O Pequeno Principe", "Saint Exupery",
                "Abril", 1920,  Categoria.Enciclopedia);

        //É necessário setar um valor na mão para que a aplicação funcione corretamente.
        livro1.setPrecoEmReais(40);

        minhaLoja.incluirItem(livro1);

        //É necessário incluir a quantidade de itens adicionados.
        minhaLoja.incluirItemParaOMapa(livro1,20);
