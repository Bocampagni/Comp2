...
public class Loja {
    ...
    public String receberPedido(Vendavel item, int quantidade, Usuario usuario)
        ...
        if (item instanceof Livro) {
            ...
            if(((Livro) item).getCategoria() == Categoria.Didatico && quantidade >= 3){
    ...
    //Sem esse método, o quantidadeEmEstoquePorItem nunca será atualizado, logo, toda referencia pra ele irá apontar para um endereço nulo.
    public void incluirItemParaOMapa(Vendavel livro1, int quantidade){
        quantidadeEmEstoquePorItem.put(livro1,quantidade);
    }
